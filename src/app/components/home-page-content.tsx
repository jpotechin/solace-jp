...
export function HomePageContent() {
  ...
  const { data, isLoading, error, refetch } = useAdvocatesQuery();
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 to-gray-50'>
      <div className='w-full px-4 sm:px-6 lg:px-8 py-8'>
        ...
        <div className='bg-gradient-to-r from-white via-blue-100 to-indigo-100 rounded-3xl shadow-xl border border-blue-300 p-8 mb-8 max-w-5xl mx-auto'>
          <div className='flex flex-col lg:flex-row gap-6 items-start lg:items-center'>
            ...
            <Button
              ...
              variant='outline'
              className='whitespace-nowrap h-14 px-8 border-indigo-400 hover:border-indigo-500 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white hover:text-white font-medium shadow-md hover:shadow-lg transition-all duration-200'
            >
              <svg
        ...
        <div className='bg-gradient-to-br from-white via-blue-100 to-indigo-100 rounded-3xl shadow-xl border border-blue-300 overflow-hidden'>
          <AdvocatesTable
            data={data?.data ?? []}
